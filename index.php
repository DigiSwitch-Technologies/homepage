						...
						<div class="col-md-10 col-lg-9">
							<div class="hero-19-txt">
								...
								<div class="btns-group">
									<a href="contact-us.php" class="btn r-04 btn--theme hover--theme">Get a Free Consultation</a>
									<a href="projects.php" class="video-popup1 btn r-04 btn--tra-black hover--theme ico-20 ico-right">See our works</a>
								</div>
							...
							<div class="row d-flex align-items-center">
								...
								<div class="col-md-7">
									<div class="banner-13-txt color--white">
										...
										<!-- Button -->
										<a href="contact-us.php" class="btn r-04 btn--theme hover--tra-white" data-bs-toggle="modal" data-bs-target="#modal-3">Get a Free Consultation</a>
